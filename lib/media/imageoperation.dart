...
class ImagePickerUI extends StatefulWidget {
  ...
  ImagePickerUI({localFileSystem})
      : this.localFileSystem = localFileSystem ?? LocalFileSystem();
  _ImagePickerUIState createState() => new _ImagePickerUIState();
...
class _ImagePickerUIState extends State<ImagePickerUI> {
  ...
  String recordVideoText = 'Record Video';
  String recordAudioText = 'Record Audio';
  ...
  void initState() {
    super.initState();
    _loadImage = new AssetImage('assets/images/default-image.jpg');
    _init();
  }
              ...
              children: <Widget>[
                Container(
                  child: Column(
                    ...
                    children: <Widget>[
                      Container(
                        padding: EdgeInsets.only(top: setHeight(6)),
                        child: InkWell(
                          child: Row(
  ...
  void _recordVideo() async {
    ImagePicker.pickVideo(source: ImageSource.camera)
      ...
      if (recordedVideo != null && recordedVideo.path != null) {
        setState(() {
          recordVideoText = 'saving in progress...';
        });
        GallerySaver.saveVideo(recordedVideo.path, albumName: albumName)
            .then((bool success) {
          setState(() {
            recordVideoText = 'video saved!';
          });
        });
      }
    });
          ...
          child: ListView(
            ...
            children: <Widget>[
              ...
              Container(
                ...
                child: Text("Click on Image to change Image"),
              ),
              RaisedButton(
